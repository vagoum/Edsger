...
%left T_Amp T_New T_Del T_Mul T_Mod T_Div T_Add T_Sub
...
function_def: result_type T_Id T_Lparen parameter_list? T_Rparen  T_Lbrace declation* statement* T_Rbrace {}
